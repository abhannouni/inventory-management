...
export function getProductClassificationLabel(isOurProduct: boolean, distributeur: string) {
  return isOurProduct || isBourchaninDistributor(distributeur) ? BOURCHANIN_CANONICAL_NAME : 'Concurrent';
}
